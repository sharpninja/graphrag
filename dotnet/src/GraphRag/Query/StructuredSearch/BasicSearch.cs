...
/// <summary>
/// Implements basic search using vector similarity and LLM completion.
/// </summary>
public class BasicSearch : ISearch
{
    private readonly ILlmCompletion llm;
    private readonly IBasicContextBuilder contextBuilder;
    private readonly ITokenizer tokenizer;
    private readonly int maxDataTokens;

    /// <summary>
    /// Initializes a new instance of the <see cref="BasicSearch"/> class.
    /// </summary>
