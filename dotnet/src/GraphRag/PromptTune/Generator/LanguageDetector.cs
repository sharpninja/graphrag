...
/// <summary>
/// Detects the primary language of the input documents using an LLM.
/// </summary>
public sealed class LanguageDetector : IPromptGenerator
{
    /// <inheritdoc/>
    public Task<string> GenerateAsync(ILlmCompletion model, IReadOnlyList<string> docs, CancellationToken ct)
    {
        // TODO: Send docs to LLM to detect language.
