...
| Project | Type | Description |
|---------|------|-------------|
| `GraphRag.SearchApp` | Blazor Server | Interactive search UI — run Global, Local, DRIFT, and Basic RAG queries with community report explorer ([Getting Started](docs/search-app-getting-started.md)) |
...
The Search App provides a browser-based UI for querying and exploring indexed datasets.
...
See the full [Search App Getting Started Guide](docs/search-app-getting-started.md) for configuration, data preparation, and usage instructions.
